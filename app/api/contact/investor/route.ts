...
export async function POST(request: NextRequest) {
  try {
    ...
    const { data, error } = await resend.emails.send({
      ...
      to: process.env.RESEND_TO_EMAIL || 'ir@alphatoncapital.com',
      replyTo: email,
      subject: `Investor Relations Contact Form: ${fullName}`,
      html: `
        <h2>New Investor Relations Contact Form Submission</h2>
      ...
      `,
      text: `
        New Investor Relations Contact Form Submission
